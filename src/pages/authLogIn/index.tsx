            ...
            <Row className="d-flex justify-content-center align-items-center vh-100">
                <Col xs={12} md={8} lg={6} xl={5}>
                    <div className="p-md-5 p-4 bg-body-tertiary custom-box-shadow rounded-3 ">
                        ...
                        {signIn.isError && <div className="alert alert-danger">Fel mejl eller lösenord</div>}
                        <Form onSubmit={handleSubmit}>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Label>Fyll i din Mejl</Form.Label>
                                <Form.Control
                                    name="email"
                                    className={`p-2 ${signIn.isError ? 'border-danger' : ''}`}
                                    type="email"
                            ...
                            <Stack direction="horizontal">
                                <div>
                                    <Button variant="primary" type="submit" disabled={signIn.isPending}>
                                        Logga in
                                        {signIn.isPending && <Spinner className="ms-2" animation="border" size="sm" />}
                                    </Button>
                                </div>
