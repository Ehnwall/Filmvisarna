...
const movies = {
  ...
  shangchi: {
    ...
    poster: {
      ...
      stående: 'https://static.posters.cz/image/1300/poster/shang-chi-and-the-legend-of-the-ten-rings-flex-i114390.jpg',
    },
    timeHour: 2,
    timeMin: 20,
    type: 'Action',
    ...
    <>
      <Container className="py-5">
        <Row className="px-4 justify-content-md-center text-center">
          <Col lg={6} className="">
            ...
            <p className="">
              Upplev de senaste filmerna i världsklass, direkt från våra bekväma och moderna salonger. Hos oss blir
              varje biobesök ett minne för livet. Hämta popcorn, luta dig tillbaka och låt filmen börja!
            </p>
      ...
      <Container className="py-4 " id="movies">
        ...
        <Stack className="mb-2 mt-3" direction="horizontal" gap={3}>
          <Dropdown>
            <Dropdown.Toggle className="btn-filter d-flex align-items-center" variant="primary" id="dropdown-basic">
              Åldrar <BsArrowDown />
            </Dropdown.Toggle>
            <Dropdown.Menu>
              {ages.map((ages, index) => (
